...
if (isset($_POST['title'],  $_POST['asin'], $_POST['mass'], $_POST['note'])) {
	...
	if (str_contains($key, "url_")) {
		...
		/////////////////////////////////////////////////////////////////////////////
		// add amazon.de/es/co.uk/it/fr/ca/nl/se   #=""
		...
		<div id="link_msg" class="alert alert-warning" role="alert" style="display:none">
          <p id="link_msg_txt"></p>
                  ...
                  <div class="row">
                    ...
                    <div class="col mb-3 col-4">
                      <label for="nameBackdrop" class="form-label">Domain</label>
                      <select name="domain" id="domain" class="form-select" data-np-intersection-state="visible">
						...
						<option value="ca">[ca] canda</option>
						<option value="nl">[nl] netherland</option>
						<option value="se">[se] sweeden </option>					  
					  </select>
                    </div>
					  
					<div class="col-4 form-check form-switch mb-2"> <br>
...
console.log(parm0);
		if (error_== 0 ){ post('add_link.php',parm0);    }
...
<div id="paypal-button-container-P-591353052D280680KMZKKBUQ"></div>
  ...
  paypal.Buttons({
      ...
      createSubscription: function(data, actions) {
        return actions.subscription.create({
          ...
          plan_id: 'P-591353052D280680KMZKKBUQ'
        });
      },
      onApprove: function(data, actions) {
        alert(data.subscriptionID); // You can add optional success message for the subscriber here
      }
  }).render('#paypal-button-container-P-591353052D280680KMZKKBUQ'); // Renders the PayPal button
</script>			
<a href="https://www.paypal.com/webapps/billing/plans/subscribe?plan_id=P-591353052D280680KMZKKBUQ">Subscribe Direct PayPal Link</a>