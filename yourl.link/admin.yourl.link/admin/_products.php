...
<a href="_product.php" class="btn btn-info mb-3">Add New Product</a>
					<br>
					<div class="row">
						<div class="col-12">
							<div class="card">
				...
				<tr>
					...
					<td>#</td>
                    <td>Client</td>
                    <td class="responsive-hidden">asin_id</td>
                    <td class="responsive-hidden">image</td>
                    <td class="responsive-hidden">free_asin_list</td>
                    <td class="responsive-hidden">Deals</td>
					<td class="responsive-hidden">Max Deals</td>
			...
			<?php if (!$accounts): ?>
                ...
                <tr>
					<td><?=$account['id']?></td>
                    <td>[<?=$account['seller_id']?>] <?=$account['seller_name']?></td> 
                    <td class="responsive-hidden"><?=$account['asin_id']?></td>
					
					
    <td class="responsive-hidden img-hover">
      <img class="img-responsive img-rounded"  width="40" height="40" src="https://admin.yourl.link/admin/uploado/<?=$account['image']?>">
                    </td>
					
                    <td class="responsive-hidden"><?=$account['free_asin_list']?></td>
                    <td class="responsive-hidden"><?=$account['deals']?></td>
					<td class="responsive-hidden"><?=$account['max_deals']?></td>
