...
$pr_list = [
	"185.132.177.55:26573:f1e48869-384567:hoeil8tog",
];
...
if ( $account['gcid_']	== 1 ){
	...
	$url = $account['url']."&rh=p_78%3A".$account['asin']."&".$account['mass'] ;	
}	
...
curl_setopt($ch, CURLOPT_PROXY, $proxy);  // prooooooooooooooooooxyyyyyy work
