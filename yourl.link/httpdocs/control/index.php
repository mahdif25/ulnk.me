...
<div class="login">
	<h1>Login</h1>
    	<form action="authenticate.php" method="post">
		      ...
		      <input type="text" class="fadeIn second" name="username" placeholder="Username" id="username" required>
      <input type="password" class="fadeIn third" name="password" placeholder="Password" id="password" required>
      
		<br>
			<center><div class="loader" id="load" style="display:none;" ></div></center>
				<div class="msg"></div><br>
				<input type="submit" id="send"  class="btn btn-primary btn-block btn-large" value="Log In" >
